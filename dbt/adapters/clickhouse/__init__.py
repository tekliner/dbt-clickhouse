...
from dbt.adapters.clickhouse.connections_http import ClickhouseConnectionManager  # noqa
from dbt.adapters.clickhouse.connections_http import ClickhouseCredentials  # noqa
